...
$$\begin{equation}\textbf{f} \big( v(t) \big) \approx -\left( a+bv(t)+cv^{2}(t) \right) \hat{\textbf{v}}\end{equation}$$
...
$$\begin{equation}\textbf{f}_{lin}\big(v(t)\big) \approx -bv(t)\hat{\textbf{v}}\tag{2}\end{equation}$$^DragEq2

$$\begin{equation}\textbf{f}_{quad}\big(v(t)\big) \approx - cv^2(t)\hat{\textbf{v}}\tag{3}\end{equation}$$^DragEq3
